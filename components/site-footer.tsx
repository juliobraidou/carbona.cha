  ...
  return (
    <footer className="border-t border-ink-hairline bg-ink">
      <div className="mx-auto max-w-[1600px] px-6 pb-8 pt-20 sm:px-10 sm:pt-28">
        <div className="grid gap-14 lg:grid-cols-[1.4fr_repeat(3,1fr)] lg:gap-10">
              ...
              <ul className="mt-5 space-y-3">
                {column.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-[15px] text-chalk-dim transition-colors duration-160 hover:text-chalk"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-20 border-t border-ink-hairline pt-6">
